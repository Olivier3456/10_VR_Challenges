...
public class FloatingAP_and_Resize : MonoBehaviour     // Don't forget to set this attach point in the XR Grab Interactable too.
{
    ...
    [SerializeField] private InputActionReference resizeRightAction;        // Must be a Press and Release input.
    [SerializeField] private InputActionReference resizeLeftAction;         // Must be a Press and Release input.
    ...
    public void ResizeRight(InputAction.CallbackContext obj)     // Don't forget to set the input as Press and Release!
    {
    ...
    public void ResizeLeft(InputAction.CallbackContext obj)     // Don't forget to set the input as Press and Release!
    {
